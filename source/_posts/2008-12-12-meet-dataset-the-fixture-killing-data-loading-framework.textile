...
<notextile>
<div class="highlight"><pre>  <span class="c1"># in test/datasets/users_dataset.rb</span><br />
  <span class="k">class</span> <span class="nc">UsersDataset</span> <span class="o">&lt;</span> <span class="no">Dataset</span><span class="o">::</span><span class="no">Base</span><br />
    <span class="k">def</span> <span class="nf">load</span><br />
      <span class="n">create_user</span> <span class="s2">&quot;John&quot;</span><span class="p">,</span> <span class="ss">:email</span> <span class="o">=&gt;</span> <span class="s2">&quot;john@example.com&quot;</span><br />
    <span class="k">end</span><br />
  <br />
    <span class="n">helpers</span> <span class="k">do</span><br />
      <span class="k">def</span> <span class="nf">create_user</span><span class="p">(</span><span class="nb">name</span><span class="p">,</span> <span class="n">attributes</span><span class="o">=</span><span class="p">{})</span><br />
        <span class="n">defaults</span> <span class="o">=</span> <span class="p">{</span> <span class="ss">:email</span> <span class="o">=&gt;</span> <span class="nb">name</span><span class="o">.</span><span class="n">gsub</span><span class="p">(</span><span class="sr">/[,. ]+/</span><span class="p">,</span> <span class="s1">&#39;.&#39;</span><span class="p">)</span> <span class="o">+</span> <span class="s2">&quot;@example.com&quot;</span> <span class="p">}</span><br />
        <span class="n">create_record</span> <span class="ss">:user</span><span class="p">,</span> <span class="nb">name</span><span class="o">.</span><span class="n">downcase</span><span class="o">.</span><span class="n">intern</span><span class="p">,</span> <span class="n">defaults</span><span class="o">.</span><span class="n">merge</span><span class="p">(</span><span class="n">attributes</span><span class="p">)</span><br />
      <span class="k">end</span><br />
      <span class="k">def</span> <span class="nf">login_as</span><span class="p">(</span><span class="n">user</span><span class="p">)</span><br />
        <span class="vi">@request</span><span class="o">.</span><span class="n">session</span><span class="o">[</span><span class="ss">:user_id</span><span class="o">]</span> <span class="o">=</span> <span class="n">user</span><span class="o">.</span><span class="n">id</span><br />
      <span class="k">end</span><br />
    <span class="k">end</span><br />
